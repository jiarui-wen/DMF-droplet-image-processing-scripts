...
save_dir = r"C:\Users\wjrwe\Documents\NTU2025ImageProcessing\image processing practice\1hz\process images"
...
img_path = r"C:\Users\wjrwe\Documents\NTU2025ImageProcessing\image processing practice\1hz\1hz_00000235.tif"
img = cv.imread(img_path, cv.IMREAD_GRAYSCALE)
cv.imwrite(os.path.join(save_dir, '00_original.png'), img)

origin_x = 65 # 新的原點 X 座標 (像素)
origin_y = 220  # 新的原點 Y 座標 (像素) 
pixel_per_mm = 630  # 每毫米多少像素

# 裁切區域：Y:170:620, X:250:1000 (1030, 325)（1150，545)
cropped_image = img[310:555, 1020:1160]
