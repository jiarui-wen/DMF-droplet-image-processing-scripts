...
save_dir = r"C:\Users\wjrwe\Documents\NTU2025ImageProcessing\image processing practice\splitting1kHz7.29\process images"
...
img_path = r"C:\Users\wjrwe\Documents\NTU2025ImageProcessing\image processing practice\splitting1kHz7.29\Q2m 1291_00001453.jpg"
img = cv.imread(img_path, cv.IMREAD_GRAYSCALE)
cv.imwrite(os.path.join(save_dir, '00_original.png'), img)

origin_x = 115 # 新的原點 X 座標 (像素)  850,830
origin_y = 795  # 新的原點 Y 座標 (像素) 
pixel_per_mm = 190/2  # 每毫米多少像素
...
# 計算逆時針旋轉 1 度的旋轉矩陣c
rotation_matrix = cv.getRotationMatrix2D(center, 3, 1)  # 1 代表旋轉 1 度，1 為縮放比例
# 使用旋轉矩陣來旋轉圖片
...
# 裁切區域：Y:170:620, X:250:1000 (735, 35) (975, 715)
cropped_image = rotated_image[35:840, 735:975]
...
# 挑选主要边缘，生成黑白图像
_, binary_image = cv.threshold(sobel_edges, 40, 255, cv.THRESH_BINARY)
